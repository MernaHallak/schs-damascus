...
function IconLink({
  ...
  return (
    <a
      ...
      rel="noreferrer"
      aria-label={label}
      className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-emerald-200/40 bg-emerald-500 text-white shadow-sm transition hover:bg-emerald-600"
    >
      {children}
    </a>
  );
        ...
        <div className="lg:hidden">
          ...
          <div className="rounded-2xl border border-emerald-200/15 bg-white/5 p-4">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              ...
              <IconLink href={s.instagramUrl} label="صفحة العيادة على إنستغرام">
                <InstagramMark />
              </IconLink>
